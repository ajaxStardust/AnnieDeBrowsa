...
4. [FUTURE.md](FUTURE.md) — roadmap / standby queue after the triad.
...
| Path-to-URL form and clickable results | [src/View/Trypath.form.php](src/View/Trypath.form.php) | Included by Main.page.php; conversion radios and links |
| Path-to-URL (alternate / duplicate fragments) | [src/View/Vue-path2url.php](src/View/Vue-path2url.php), [public/content/form-trypath.content.php](public/content/form-trypath.content.php) | Same URL-building pattern as Trypath |
| Newmethod debug URL HTML | [src/Model/Newmethod.php](src/Model/Newmethod.php) (`buildUrlLast`) | Legacy `_construct_NewMethod` / debug link output |
| Path-to-URL scheme for outputs | (see above) | **Always `http://`** for generated links; developer tool only—no scheme toggles |
| Page tools flyout (`#pageControls`, shell only) | [src/View/html-main.page.php](src/View/html-main.page.php), [public/content/content-page-controls.php](public/content/content-page-controls.php), [src/View/html-maincontrols.page.php](src/View/html-maincontrols.page.php), [public/assets/css/tachyons-extended.css](public/assets/css/tachyons-extended.css) | Peripheral UX: Show/Hide via `#toggle`; see [WHY.md](WHY.md) “core vs peripheral” |
...
- (Optional) **Page tools** flyout: **Show/Hide Controls** still works; panel is **nav-dark** themed—not core app behavior

2. Open /public/default.php and verify:
- transform form works
- conversion result links (buildByComp / concatThis / concatSwitch) use **`http://`** as the scheme

<!-- ^ Trypath.form.php -->
 <header>
    <h1><?= $page_heading; ?></h1>
<details id="processingSummary" class="mb3">
    <summary>path processing details</summary>
    <div id="glossary_01" class="bg-light-gray pa2 pv2 mt2 br2">
        ...
        <ul>
            <li>
                <code>buldByComp</code> uses _SERVER[], path[], to build the resulting HTTP url.
            </li>
            <li>
                <code>concatThis</code> uses that info but first removes some standard known
            paths in attempt to achive a more likely correct URL, and tends to be the most
            reliable of the three results.
            </li>
            <li>
                <code>concatSwitch</code> employs the use of a switch case logic. This is usually
            garbage for some reason. All in the spirit of playing with code.
            </li>
        </ul>
    ...
    $trimmed_new_url = str_ireplace("/opt/lampp/htdocs/" . $contructNewMethod["_dynamichost"],"",$contructNewMethod["new_url_concat"]);

    ...
    plugin = {
      ...
      controls: function () {
        if (settings.controls) {
          $el.after(
            '<div class="sans-serif lSAction"><a class="sans-serif lSPrev">' +
              settings.prevHtml +
              '</a><a class="sans-serif lSNext">' +
              settings.nextHtml +
              "</a></div>"
          );
      ...
      initialStyle: function () {
        ...
        $el
          ...
          .wrap(
            '<div class="sans-serif lSSlideOuter ' +
              settings.addClass +
              '"><div class="sans-serif lSSlideWrapper"></div></div>'
          );
      ...
      pager: function () {
        ...
        if (settings.pager) {
          ...
          $slide.after('<ul class="sans-serif lSPager ' + cl + '"></ul>');
